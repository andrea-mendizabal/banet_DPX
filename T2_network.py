...
BanetNetwork: simply returns the input as output.
BanetOptimizer: nothing to optimize in our BanetNetwork.
"""
...
class BanetNetwork(BaseNetwork):

    def __init__(self, config):
        BaseNetwork.__init__(self, config)
        # There is no Network architecture to define in our BanetNetwork
    ...
    This BanetNetwork has no parameters so it does not behave like a real neural network.
    """
...
class BanetOptimization(BaseOptimization):
    ...
    """
    The following methods should be already defined in a DeepPhysX AI package.
    This BanetOptimization has nothing to compute.
    """
